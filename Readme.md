...
# Parsing + Configuration Script – TERLORXL001.0BATTS/US915 - Rev. A

This **Parsing + Configuration** script is designed for the **TERLORXL001.0BATTS/US915** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – TERLORXL001.0BATTS/US915 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **TERLORXL001.0BATTS/US915** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
